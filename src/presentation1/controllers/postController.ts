...
import { IPostUsecase } from "../../domain1/interfaces/use-cases/Post-Service/Post-usecase";
import { Media } from "../../domain1/entities/POST";
...
export class PostController {
    ...
    async createPost(req: Request, res: Response,next:NextFunction) {
        const { doctorId, title, content, tags } = req.body;
